...
func WalkSlice(p *Parser, slice *[]uint8, g *chainhash.Hash, l *blocks.Block, height *int32, skipped int) (goalPrevHash *chainhash.Hash, lastBlock *blocks.Block, s int, err error) {
	goalPrevHash = g
	lastBlock = l
	for len(*slice) > 0 {
		select {
...
func (p *Parser) findCheckPointByHash(chain [][]uint8, last *models.Block) (block *blocks.Block, err error) {
